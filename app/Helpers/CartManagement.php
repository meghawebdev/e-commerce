...
class CartManagement
{
    ...
    {
        Cookie::queue('cart_items', json_encode($cart_items), 60 * 24 * 30); // all cookies will be saved in the browser for 30 days. After 30 days, it will be expired until we clear manually.
    }
