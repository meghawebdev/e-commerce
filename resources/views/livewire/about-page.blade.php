        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident magni quibusdam impedit iusto tenetur, eius laborum.</p>
                <p class="mt-6 text-lg leading-8 text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Asperiores quas tempore velit, voluptatibus eum labore aliquam non nostrum aliquid ab dicta
                    eligendi, distinctio pariatur odit neque facere perspiciatis vel nisi, quia quibusdam. Nisi
                    consequuntur voluptatibus voluptate sequi necessitatibus inventore natus.</p>
            </div>
        </div>
    </div>
            ...
            <div
                ...
                <div class="lg:pr-8 lg:pt-4">
                    <div class="lg:max-w-lg">
                        <h2 class="text-base font-semibold leading-7 text-indigo-600">Story</h2>
                        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our Story
                        </p>
