        ...
        <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                                ...
                                <tr wire:key="{{ $item['product_id'] }}">
                                    <td class="py-4">
                                        <div class="flex items-center">
                                            <img class="h-16 w-16 mr-4" src="storage/{{ $item['image'] }}"
                                                alt="Product image">
                                    ...
                                    <td><button wire:click="removeItem({{ $item['product_id'] }})"
                                            class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700"><span
                                                ...
                                                wire:loading.remove>Remove</span><span wire:loading
                            ...
                            @empty
                                <tr>
                                    <td colspan="5"
                                        class="text-center py-4  text-4xl font-semibold
                                 text-slate-500">
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    @if ($cart_items)
                        <a href="/checkout"
                            class="block text-center bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
                    @endif
                </div>
            </div>
        </div>
