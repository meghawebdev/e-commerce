                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model="phone_number"
                                class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('phone_number') border-red-500 @enderror"
                                id="phone" type="text">
                            </input>
                            @error('phone_number')
                                <div class="text-red-500 text-sm">{{ $message }}</div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                <label class="block text-gray-700 dark:text-white mb-1" for="pin">
                                    PIN Code
                                </label>
                                <input wire:model="pin_code"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('pin_code') border-red-500 @enderror"
                                    id="pin" type="text">
                                </input>
                                @error('pin_code')
                                    <div class="text-red-500 text-sm">{{ $message }}</div>
